...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_CHOSEN|nordic,pm-ext-flash" "/soc/spi@40003000/flash@0")
...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/soc/spi@40003000/flash@0" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|w25q128jv" "/soc/spi@40003000/flash@0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|wakeup-source" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|zephyr,pm-device-runtime-auto" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|compatible" "jedec,spi-nor;")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|reg" "0;")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|zephyr,deferred-init" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|spi-max-frequency" "32000000")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|duplex" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|frame-format" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|spi-cpol" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|spi-cpha" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|spi-hold-cs" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|jedec-id" "239;64;24;")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|size" "16777216")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|requires-ulbpr" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0|has-dpd" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/soc/spi@40003000/flash@0|NUM" "1")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/soc/spi@40003000/flash@0|ADDR" "0x0;")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/soc/spi@40003000/flash@0|SIZE" "NONE;")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/soc/spi@40003000/flash@0/partitions" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/soc/spi@40003000/flash@0/partitions|NUM" "0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/soc/spi@40003000/flash@0/partitions|ADDR" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/soc/spi@40003000/flash@0/partitions|SIZE" "")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODE|/soc/spi@40003000/flash@0/partitions/partition@0" TRUE)
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_NODELABEL|storagefs" "/soc/spi@40003000/flash@0/partitions/partition@0")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0/partitions/partition@0|label" "storagefs")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0/partitions/partition@0|read-only" "False")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/spi@40003000/flash@0/partitions/partition@0|reg" "0;16777216;")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/soc/spi@40003000/flash@0/partitions/partition@0|NUM" "1")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/soc/spi@40003000/flash@0/partitions/partition@0|ADDR" "0x0;")
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_REG|/soc/spi@40003000/flash@0/partitions/partition@0|SIZE" "0x1000000;")
...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_COMP|jedec,spi-nor" "/soc/spi@40003000/flash@0")
